...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addButton.addEventListener('click', add.bind());
  showButton.addEventListener('click', show.bind(id, name, address));
  editButton.addEventListener('click', edit.bind(name, address));
...
/******/ });
//# sourceMappingURL=company-4915f68a59b73c497004.js.map